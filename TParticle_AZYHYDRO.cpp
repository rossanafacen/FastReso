...
TParticle_AZYHYDRO::TParticle_AZYHYDRO(int pdgcode, std::string name, double mass, double gamma, int nu,
    double qb, double qs, double qc, double qbot, double isospin, double charge, int ndecays, string comps)
{
...
//   printf("# \033[1mCreate particle\033[0m : \033[1;32m%s\033[0m ;\tm = %9f GeV;\tnu = %d ;\n", fParticleName.c_str(), fMass, fNu);
